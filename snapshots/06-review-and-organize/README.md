...
Keep implementation aligned with **`docs/01-loyalty-points-checkout-plan.md`** at the tutorial repository root. Snapshots carry **code and tests** only; the plan is not duplicated here.
